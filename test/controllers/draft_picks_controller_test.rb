...
class DraftPicksControllerTest < ActionController::TestCase
  ...
  test "should create draft_pick" do
    assert_difference('DraftPick.count') do
      post :create, draft_pick: { draft_id: @draft_pick.draft_id, fantasy_team_id: @draft_pick.fantasy_team_id, player_id: @draft_pick.player_id, price: @draft_pick.price, round: @draft_pick.round }
    end
  ...
  test "should update draft_pick" do
    patch :update, id: @draft_pick, draft_pick: { draft_id: @draft_pick.draft_id, fantasy_team_id: @draft_pick.fantasy_team_id, player_id: @draft_pick.player_id, price: @draft_pick.price, round: @draft_pick.round }
    assert_redirected_to draft_pick_path(assigns(:draft_pick))
  end
